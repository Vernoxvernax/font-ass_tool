...
use fontconfig_sys::{
  ...
  FcPatternCreate, FcPatternAddInteger, FcConfigBuildFonts, FcInitLoadConfig, FcFontSetCreate, FcConfigGetFonts, FcPatternGetBool, FcFontSetDestroy, FcWeightFromOpenType, FcSetApplication,
};
